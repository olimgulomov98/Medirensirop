...
export const metadata = {
  ...
  url: "https://medirensirop.netlify.app",
  image: "https://medirensirop.netlify.app/mediren-logo.svg",
  content: "МЕДИРЕН",
};
  ...
  return (
    <html lang="en">
      <head>
        ...
        />
        <link rel="canonical" href="https://www.medirensirop.uz/" />
        <meta property="og:url" content="https://medirensirop.uz/" />
        <meta property="og:title" content="МЕДИРЕН" />
        <meta property="og:description" content="МЕДИРЕН" />
        <meta
          property="og:image"
          content="https://medirensirop.netlify.app/mediren-logo.svg"
        />
        <meta property="og:image:width" content="800" />
        <meta property="og:image:height" content="600" />
        <meta
          property="og:image"
          content="https://medirensirop.netlify.app/mediren.png"
        />
